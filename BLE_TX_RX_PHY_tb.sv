...
module BLE_TX_RX_PHY_tb ();
    ...
    // RX Signals
    //==========================================================================
    wire                            demod_signal_o_tb;
    wire                            demod_signal_valid_o_tb;
    wire rx_bit_tb;
    ...
    initial begin
        ...
        //$readmemh("taps.txt", TX.u_gaussian_filter.store_taps);
        ...
        $display("Message: 0b11111111110");
        $display("========================================");
        
        test_message = 11'b11111111110;
        send_message(test_message);
    ...
    //==========================================================================
    // RX Demodulator (FM Discriminator)
    //==========================================================================
    BLE_RX_PHY #(
    ...
    .clk(clk),
    .rst_n(rst_n),
    .in_phase_i_i(In_Phase_o_tb),
    .quadrature_q_i(Quadrature_Phase_o_tb),
    .iq_valid_i(Phase_Valid_o_tb),
    .rx_bit_o(rx_bit_tb),
